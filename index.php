...
curl_setopt_array($curl, [
	CURLOPT_URL => "https://biztoc.p.rapidapi.com/search?q=google",
	CURLOPT_RETURNTRANSFER => true,
	CURLOPT_ENCODING => "",
	CURLOPT_MAXREDIRS => 10,
	CURLOPT_TIMEOUT => 30,
  ...
  $coun = 0;
    ...
    foreach ($data as $article) {
      ...
      if (1) {
        ...
        echo "<img src='" . $article['img']['s'] .  "' alt='Thumbnail' class='hotspot_image_img'><br><br>";
    ...
    if (1) {
      ...
      foreach ($data as $article) {
          ...
          if (isset($article['title'])) {
              echo "<div class='hotspot_headline_1'><p>". $count .".) ". $article['title'] . "</p></div>";
          }
          if (isset($article['url'])) {
              echo "<div class='url_of_text'><a href='" . $article['url'] . "' target='_blank'>Read more</a></div>";
          }
